                ...
                <div>
                    ...
                    <nav className="space-y-1">
                        ...
                        <Link to="/transactions">
                            <a className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 font-medium text-xs transition-colors">
